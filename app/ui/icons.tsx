...
export { gestionIcon, disponibilityIcon, signOutIcon, ExclamationCircleIcon, CheckCircleIcon, SearchIcon, TrashIcon, PencilIcon, PlusIcon, IdentificationIcon, AtSymbolIcon, UserPlusIcon };